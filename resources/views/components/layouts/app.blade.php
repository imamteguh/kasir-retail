        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah anda yakin ingin menghapus data ini? Tindakan ini tidak dapat di ulangi.
                </div>
                <div class="modal-footer">
                    <button type="button" id="batal" class="btn btn-label-secondary" data-bs-dismiss="modal">Batal</button>
